  ...
  <body style="background: #f8fafc;">
    ...
    <div class="container">
      <div class="jumbotron text-center" style="padding:100px 50px;">
        ...
        <h1>Halo, <?php echo isset($_SESSION['nama']) ? $_SESSION['nama'] : 'Selamat Datang'; ?>!</h1>
        <p style="font-size: 1.2rem; opacity: 0.9;">Panel <?php echo ucfirst(isset($_SESSION['role']) ? $_SESSION['role'] : 'User'); ?> Hum Hum Laundry - Kelola transaksi dengan mudah dan cepat.</p>
      </div>
    </div>
